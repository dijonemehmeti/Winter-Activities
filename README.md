...
- Original photos and one video taken and imported by the author
- Signup form that uses the GET method to send data to `example.org`
- All files organized in a single folder structure
